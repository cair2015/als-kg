# Contributing to ALS-KG

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
ALS-KG. These guidelines are not strict rules.
...
The ALS-KG team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the ALS-KG technical leads
...
[issues]: https://github.com//ALS-KG/issues/
[pulls]: https://github.com//ALS-KG/pulls/
